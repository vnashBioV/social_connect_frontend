             ...
             <div className='flex justify-between items-center gap-2 w-full'>
                  {destination && (
                    <a 
                      ...
                      target="_blank"
                      rel='noreferrer'
                      className='bg-white flex items-center gap-2 text-black font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shodow-md'
                    >
                  ...
                  {postedBy?._id === user?.googleId && (
                    ...
                    type='button'
                    className='bg-white opacity-70 hover:opacity-100 font-bold text-dark text-base rounded-3xl hover:shodow-md outlined-none'
                    >
                      <AiTwotoneDelete/>
                    </button>
                  )
